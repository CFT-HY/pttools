...
def main():
    ...
    data = xiv_plane(df_dtau_ptr=df_dtau_ptr, cs2_s=model.css2, cs2_b=model.csb2)
    fig: plt.Figure = plt.figure()
    ax: plt.Axes = fig.add_subplot()
    plot_plane(ax=ax, deflag=data, cs2_s=model.css2, cs2_b=model.csb2, selected_solutions=False)
