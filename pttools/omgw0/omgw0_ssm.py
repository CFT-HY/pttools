...
def get_f0(rs, T=T_default):
    """
    Factor required to take into account redshift of frequency scale
    See Eqn 2.13 of arXiv:2106.05984
    """
    return 2.6e-6/rs * (T/100) * (100/100)**(1/6)

def calc_omgw0(freqs, vw, alpha, rs, T=T_default, npt=NPTDEFAULT, suppression=SUP_METHOD_DEFAULT):
    """
