...
class DataModel(Model):
    ...
    def from_hdf5(cls, path: str, name: str | None = None, T_is_physical: bool = False) -> "DataModel":
        ...
        with File(path, "r") as file:
            if name is None:
                name = file.attrs["model_label"] if "model_label" in file.attrs else os.path.splitext(os.path.basename(path))[0]
            ...
            if "high_temperature_phase" in file and "low_temperature_phase" in file:
                ...
                T_min = phase_b.attrs["min_possible_temperature"] if "min_possible_temperature" in phase_b.attrs else None
                T_max = phase_s.attrs["max_possible_temperature"] if "max_possible_temperature" in phase_s.attrs else None
                return cls(
