...
def alpha_n_max_bag(
    ...
    return alpha_n_max_deflagration_bag(
        v_wall, df_dtau_ptr=df_dtau_ptr, ode_method=ode_method, cs2_ptr=cs2_ptr, n_xi=n_xi)
...
def _alpha_n_max_deflagration_bag_arr(
    ...
    for i in numba.prange(v_wall.size):
        ret[i] = _alpha_n_max_deflagration_bag_scalar_numba(
            v_wall[i], df_dtau_ptr=df_dtau_ptr, ode_method=ode_method, cs2_ptr=cs2_ptr, n_xi=n_xi)
    return ret
