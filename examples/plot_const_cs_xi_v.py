...
def main():
    ...
    v, w, xi, sol_type, _, _, failed = fluid_shell_generic(model2, v_wall=0.85, alpha_n=0.05, sol_type=SolutionType.DETON)
    ax.plot(xi, v, c="b", label=r"$c_{sb}=\frac{1}{\sqrt{3}}$")
    v, w, xi = fluid_shell(v_wall=0.85, alpha_n=0.05)
    ax.plot(xi, v, c="g", label="bag", ls=":")
    v, w, xi, sol_type, _, _, failed = fluid_shell_generic(
    ...
    v, w, xi, sol_type, _, _, failed = fluid_shell_generic(model3, v_wall=0.95, alpha_n=0.15, sol_type=SolutionType.DETON)
